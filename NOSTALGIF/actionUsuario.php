...
<?php
    ...
    $fotoUsuario = $nomeUsuario = $campusUsuario = $telefoneUsuario = $emailUsuario = $senhaUsuario = $confirmarSenhaUsuario = "";
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($_POST["campusUsuario"])){
            echo "<div class='alert alert-warning text-center'>O campo <strong>CAMPUS</strong> é obrigatório!</div>";
            $erroPreenchimento = true;
        }
        else {
            $campusUsuario = filtrar_entrada($_POST["campusUsuario"]);
        }
        ...
        if(!$erroPreenchimento && !$erroUpload){
            ...
            $inserirUsuario = "INSERT INTO Usuarios (fotoUsuario, nomeUsuario, campusUsuario, telefoneUsuario, emailUsuario, senhaUsuario) VALUES ('$fotoUsuario', '$nomeUsuario', '$campusUsuario', '$telefoneUsuario', '$emailUsuario', '$senhaUsuario')";
